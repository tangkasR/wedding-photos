...
export const metadata: Metadata = {
  ...
  description: `Share beautiful moments from ${coupleName}'s wedding${weddingDate ? ` on ${weddingDate}` : ""}.`,
};

export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning>
      <body className={`min-h-screen ${cormorant.variable} ${jost.variable}`} suppressHydrationWarning>
        {children}
      </body>
    </html>
  );
